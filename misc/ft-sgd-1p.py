# author: Furkan Cayci
# description:
#   stochastic gradient descent implementation over 1 parameter
#
# result:
#   Success average is 23.88 iterations over 100 trials for python impl.
#   Success average is 23.26 iterations over 100 trials for lims
#     with pert=.8, nodesize=(11,21), boardsize=(.2,.4), threshold=1
